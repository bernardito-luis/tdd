...
class MyListsTest(FunctionalTest):
    ...
    def create_pre_authenticated_session(self, email):
        ...
        ## to set a cookie we need first visit the domain
    ...
    def test_logged_in_users_lists_are_saved_as_my_lists(self):
        ...
        # She seas that her list is in there, named according to its
        # first list item
        ...
        self.browser.find_element_by_link_text('id_logout').click()
        self.assertEqual(
